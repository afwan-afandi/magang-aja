  ...
  <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <br>
            <h2 class="page-title">Dashboard | Input Gelombang </h2>
            <center><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalScrollable">
              Tambah Gelombang
            </button></center>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">Input Gelombang v1</li>
              </ol>
            </nav>
          </div>
...
?>
  <tbody style="background-color:white;">
    ...
    <td style="text-align: center;">
      ...
      <a title="hapus" class="btn btn-danger mdi mdi-delete" style="font-size: 20px;" href="proses/pros_hapus_gel.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>&nbsp;
    </td>
  </tbody>
  <!-- Modal -->
